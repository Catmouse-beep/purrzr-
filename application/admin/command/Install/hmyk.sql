...
-- Records of hm_admin
-- ----------------------------
INSERT INTO `hm_admin` VALUES (1, 'admin', 'Admin', 'b01ac0e226d8377c3f02f933ca3d2f73', 'ab900d', 'http://hm.test.com/assets/img/avatar.png', 'admin@admin.com', '', 0, 1681452704, '127.0.0.1', 1491635035, 1681452704, 'be56b7c2-5707-431d-a154-014746a7f795', 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of hm_admin_log
-- ----------------------------
INSERT INTO `hm_admin_log` VALUES (1, 1, 'admin', '/admin/plugin/myplugin/setting/plugin_name/epay/ids/1?dialog=1', '', '{\"dialog\":\"1\",\"gateway_url\":\"\",\"appid\":\"\",\"secret_key\":\"\",\"plugin_name\":\"epay\",\"ids\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681458690);
INSERT INTO `hm_admin_log` VALUES (2, 1, 'admin', '/admin/plugin/myplugin/status/cmd/enable', '', '{\"action\":\"\",\"ids\":\"epay\",\"params\":\"\",\"cmd\":\"enable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681458691);
INSERT INTO `hm_admin_log` VALUES (3, 1, 'admin', '/admin/plugin/myplugin/status/cmd/enable', '', '{\"action\":\"\",\"ids\":\"sheshou\",\"params\":\"\",\"cmd\":\"enable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681458696);
INSERT INTO `hm_admin_log` VALUES (4, 1, 'admin', '/admin/plugin/myplugin/delp/plugin_name/sheshou/ids/3', '', '{\"plugin_name\":\"sheshou\",\"ids\":\"3\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681458704);
...
CREATE TABLE `hm_options`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '配置' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hm_options` VALUES (4, 'version', '1.0.6', '数据表版本');
...
INSERT INTO `hm_sku` VALUES (38, 10, NULL, '{\"crossed_price\":\"\",\"cost_price\":\"\",\"sale_price\":\"\",\"agency_price_1\":\"\",\"agency_price_2\":\"\",\"agency_price_3\":\"\",\"agency_price_4\":\"\"}', 0);
...
-- ----------------------------
INSERT INTO `hm_user_agency` VALUES (1, '普通代理', 9.50, 15.00, 4, 1678969619, 1681454105, NULL);
